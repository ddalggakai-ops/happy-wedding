...
큰 성당 건물로 들어가시면 저희를 찾기 어려우실 수 있어요. 성당 마당으로 들어오셔서 '파밀리아 채플' 안내를 따라와 주시면, 반갑게 맞이하겠습니다.`,
      ...
      },
      {
        label: "주차",
        icon: "🅿️",
        title: "지하철이 가장 편하실 거예요",
        text: `성당 지하주차장을 이용하실 수 있지만, 예식일이 일요일이라 미사에 오시는 차량으로 자리가 넉넉하지 않을 수 있어요.

주차 요금도 최초 30분 3,000원, 이후 10분당 1,000원으로 적지 않아서, 지하철로 와주시면 오시는 길이 한결 수월하실 거예요.`,
