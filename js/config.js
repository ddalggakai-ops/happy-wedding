    ...
    tabs: [
      {
        ...
        text: `예식은 명동성당 안에 자리한 작은 예식 공간, **파밀리아 채플**에서 올립니다. 성당 하면 떠올리시는 큰 본당 건물이 아니라, 같은 마당 안에 따로 자리한 아담한 예식 공간이에요.

큰 성당 건물 쪽으로 바로 들어가시면 저희를 찾기 어려우실 수 있습니다. 성당 마당으로 들어오셔서 '파밀리아 채플' 안내를 따라와 주세요.

처음 오시는 길이라 헷갈리실 수 있는데, 그래도 괜찮습니다. 여유 있게 오셔서 편안히 둘러보시고, 잘 모르시겠으면 언제든 편하게 연락 주세요. 반갑게 맞이하겠습니다.`,
      ...
      },
      {
        ...
        text: `하객 분들께서는 파인애비뉴 빌딩 주차장을 이용해주시기 바라며, **2시간 무료 주차 이용권**을 제공해 드립니다. 추가로 필요하신 하객 분들께서는 신랑, 신부에게 말씀해주시기 바랍니다.

※ 명동성당 지하 주차장 이용 시 주차권 제공이 어렵습니다.
※ **SK 사원증/패밀리카드 소지 시**, 을지로 **SKT 타워 무료 이용** 가능합니다.`,
        // 누르면 주소가 복사되는 버튼이 생깁니다 (비우면 버튼 없음)
        copy: "서울 중구 을지로 100",
        note: "예식장까지 도보 10분 거리예요",
      },
      {
        label: "혼배미사",
        icon: "💒",
...
일반 예식장과는 순서가 조금 달라 낯설게 느껴지실 수도 있지만, 특별히 준비하실 것은 없습니다. 자리에 앉아 편안히 함께해 주시면 되고, 저희 두 사람이 서약하는 순간을 따뜻하게 지켜봐주시면 감사하겠습니다.`,
