...
const WEDDING_CONFIG = {
  ...
  venue: {
    ...
    address: "서울특별시 중구 명동길 66",
    // 네이버지도·카카오맵·티맵 버튼을 눌렀을 때 검색되는 문구입니다.
    // (비워두면 위의 name + hall + address 를 붙여서 씁니다)
    mapQuery: "명동성당 파밀리아 채플, 서울특별시 중구 명동길 66",
    // 명동대성당 좌표 (지도 앱 연동용)
    lat: 37.563646,
    lng: 126.987120,
    transit: {
      ...
      // **양쪽을 별표 두 개로 감싸면** 굵게 표시됩니다
      parking: "파인애비뉴 빌딩 (서울 중구 을지로 100)\n* 명동성당 지하주차장 이용 시 주차권 제공이 어렵습니다.\n* **SK 사원증/패밀리카드 소지 시, 을지로 SKT 타워 무료 이용** 가능해요.",
    },
  },
    ...
    tabs: [
      {
        label: "장소",
        icon: "⛪",
        title: "예식은 '파밀리아 채플'에서 진행됩니다",
        // 제목 아래 한눈에 들어오는 핵심 칩 (필요 없으면 이 줄을 지우세요)
        points: [{ icon: "⛪", text: "파밀리아 채플" }, { icon: "📍", text: "입구 우측 붉은 건물" }],
        text: `명동성당 안의 작은 예식 공간, **파밀리아 채플**에서 식이 진행됩니다. 

        명동대성당 올라가기 전, 입구 우측 붉은색 건물이 파밀리아 채플입니다.`,
        note: "지도 앱에서 '명동성당 파밀리아채플'로 검색하실 수 있습니다.",
      },
      {
        label: "주차",
        icon: "🅿️",
        title: "파인애비뉴 빌딩 또는 을지로 SKT타워를 이용해주세요",
        points: [{ icon: "🅿️", text: "파인애비뉴 빌딩" }, { icon: "🎫", text: "2시간 무료" }],
        text: `파인애비뉴 빌딩 이용 시 **2시간 무료 주차 이용권**을 제공해 드립니다. 추가로 필요하신 하객 분들께서는 신랑, 신부에게 말씀해주시기 바랍니다.

         **SK 사원증/패밀리카드 소지 시, 을지로 SKT 타워 무료 이용** 가능합니다.
※ 명동성당 지하 주차장 이용 시 주차권 제공이 어렵습니다.`
      },
      {
        ...
        points: [{ icon: "⏱️", text: "약 50분" }, { icon: "📄", text: "식순지 제공" }],
        text: `성당에서 올리는 예식으로, **50분 가량의 혼배미사**로 진행됩니다.

일반 예식장과는 순서가 조금 달라 낯설게 느껴지실 수 있어, 식순지를 준비했습니다. 종교와 상관 없이 편안히 함께해 주시면 되고, 저희 두 사람이 서약하는 순간을 따뜻하게 지켜봐주시면 감사하겠습니다.`,
      ...
      },
      {
        ...
        text: `먼 길 오시는 걸음이 조금이나마 편안하시도록, \n제천 출발/원주 경유 버스를 준비했습니다.`,
        stops: [
  ...
  bingo: {
    title: "포토 빙고",
    desc: `포토 빙고의 한 줄(가로/세로/대각선)을 채워 응모해주시면,
추첨을 통해 소정의 경품을 드립니다!`,
