...
const WEDDING_CONFIG = {
  ...
  venue: {
    ...
    transit: {
      ...
      parking: "파인애비뉴 빌딩 (서울 중구 을지로 100, 도보 10분)\n※ 명동성당 주차장 이용 시, 주차 요금 지원이 어렵습니다.",
    },
  },
...
큰 성당 건물로 들어가시면 저희를 찾기 어려우실 수 있어요. 성당 마당으로 들어오셔서 '파밀리아 채플' 안내를 따라와 주시면, 반갑게 맞이하겠습니다.`,
      ...
      },
      {
        ...
        text: `하객분들께서는 파인애비뉴 빌딩 주차장을 이용해주시면 됩니다.
(서울 중구 을지로 100 · 예식장까지 도보 10분)

※ 명동성당 지하 주차장을 이용하실 경우, 주차 요금 지원이 어렵습니다.
※ SK 사원증·패밀리카드를 소지하신 분은 을지로 SKT타워 주차장도 이용하실 수 있습니다.`,
        note: "4호선 명동역 8번 출구에서 걸어서 5분이면 도착합니다",
      },
      {
        label: "혼배미사",
        icon: "💒",
        title: "혼배미사로 예식을 올립니다",
        text: `성당에서 올리는 예식이라 일반 예식장과는 조금 달리, 한 시간가량 혼배미사로 진행됩니다.

종교와 관계없이 편안히 앉아 계시면 되고, 저희 두 사람이 서약하는 순간만 따뜻하게 지켜봐 주시면 더 바랄 것이 없겠습니다.`,
      ...
      },
      {
        ...
        text: `먼 길 오시는 걸음이 조금이나마 편안하시도록, 제천에서 출발하는 버스를 준비했습니다.`,
        stops: [
