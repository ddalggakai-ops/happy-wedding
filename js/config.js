    ...
    tabs: [
      {
        ...
        명동 대성당 올라가기 전, 입구 우측의 붉은색 건물이 파밀리아 채플입니다.`,
      ...
      },
      {
        ...
        text: `파인애비뉴 빌딩 이용 시 **2시간 무료 주차 이용권**을 제공해 드립니다. 

        (※ 주차권이 추가로 필요하신 하객 분들께서는 신랑, 신부에게 말씀해주세요!)

         **SK 사원증/패밀리카드 소지 시, 을지로 SKT 타워 무료 이용** 가능합니다.`,
        note: "명동성당 지하 주차장 이용 시 주차권 제공이 어렵습니다."
      },
      {
        label: "혼배미사",
        icon: "💒",
        title: "혼배미사 형식으로 예식을 올립니다",
        text: `천주교 성당에서의 **혼배미사** 형식으로 예식이 진행됩니다.

일반 예식장과는 순서가 조금 달라 낯설게 느껴지실 수 있어, 식순지를 준비했습니다. 

종교와 상관 없이 편안히 함께 자리해 주시고, 저희 두 사람이 서약하는 순간을 따뜻하게 지켜봐주시면 감사하겠습니다.`,
...
추첨을 통해 소정의 경품을 드립니다!`,
    ...
    cells: [
      ...
      { icon: "🕊️", text: "사랑을 서약하는 신랑·신부의 모습" },
    ],
  },
