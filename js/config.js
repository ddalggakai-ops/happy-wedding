...
const WEDDING_CONFIG = {
  ...
  venue: {
    ...
    transit: {
      ...
      parking: "파인애비뉴 빌딩 (서울 중구 을지로 100, 도보 10분)\n*명동성당 주차장 이용 시, 주차요금 지원이 어려워요.\n*SK 사원증/패밀리카드 소지 시, 을지로 SKT타워 이용가능해요.",
    },
  },
...
큰 성당 건물로 들어가시면 저희를 찾기 어려우실 수 있어요. 성당 마당으로 들어오셔서 '파밀리아 채플' 안내를 따라와 주시면, 반갑게 맞이하겠습니다.`,
      ...
      },
      {
        ...
        text: `하객분들께서는 파인애비뉴 빌딩 주차장 이용해주시면 됩니다.
(서울 중구 을지로 100, 도보 10분)

※명동성당 지하 주차장 이용 시, 주차요금 지원이 어렵습니다.
※**SK 사원증/패밀리카드 소지**하신 분은, 을지로 SKT타워 주차장이용 가능합니다.`,
        note: "파인애비뉴 빌딩 주차장은 2시간 무료로 지원해 드립니다",
      },
      {
        label: "혼배미사",
        icon: "💒",
