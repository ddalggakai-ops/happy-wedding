...
손 꼭 잡고 걸어갈게. 사랑해.`,
  ...
  info: {
    headline: "모두에게 즐거운 날이 되기를 바라며",
    tabs: [
      {
        label: "장소",
        icon: "⛪",
        title: "대성당이 아닌 '파밀리아 채플'입니다",
        text: `예식은 명동성당 경내에 있는 별도의 건물, 파밀리아 채플에서 진행됩니다.

큰 성당(대성당)으로 오시면 예식장을 찾기 어려우니, 성당 마당으로 들어오신 뒤 '파밀리아 채플' 안내를 따라와 주세요.`,
        note: "지도 앱에서도 '명동성당 파밀리아채플'로 검색됩니다",
      },
      {
        label: "주차",
        icon: "🅿️",
        title: "가급적 대중교통을 이용해 주세요",
        text: `명동성당 지하주차장(파밀리아 채플 주차장)을 이용하실 수 있지만, 예식일이 일요일이라 미사 차량으로 매우 혼잡합니다.

주차 요금도 최초 30분 3,000원, 이후 10분당 1,000원으로 적지 않게 나오는 점 참고해 주세요.`,
        note: "4호선 명동역 8번 출구에서 도보 5분입니다",
      },
      {
        label: "혼배미사",
        icon: "💒",
        title: "미사 형식으로 진행됩니다",
        text: `성당에서 올리는 예식이라 일반 예식장과 달리 혼배미사로 진행됩니다.

종교와 관계없이 편하게 자리해 주시면 되고, 미사 중에는 이동과 통화를 잠시만 삼가 주시면 감사하겠습니다.`,
        note: "화환은 정중히 사양합니다. 마음만 감사히 받겠습니다",
      },
      {
        label: "대절버스",
        icon: "🚌",
        title: "제천에서 출발합니다",
        text: `멀리서 와주시는 걸음이 편하시도록 제천 출발 대절버스를 준비했습니다.`,
        stops: [
...
추첨을 통해 소정의 경품을 보내드릴게요!`,
    ...
    cells: [
      ...
      { icon: "💐", text: "부케 또는 꽃 장식" },
      { icon: "💍", text: "신랑·신부와 셋이서" },
      { icon: "🥂", text: "축배를 드는 순간" },
      { icon: "😂", text: "오늘 제일 크게 웃은 얼굴" },
